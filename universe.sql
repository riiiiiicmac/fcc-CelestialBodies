...
CREATE TABLE public.galaxy (
    ...
    name character varying(255) NOT NULL,
    speed_of_light integer DEFAULT 299792458 NOT NULL
);
...
INSERT INTO public.comets VALUES (2, 'Encke', 1);
INSERT INTO public.comets VALUES (3, 'Kohoutek', 1);
...
INSERT INTO public.galaxy VALUES (1, 'In the Babylonian epic poem Enūma Eliš, the Milky Way is created from the severed tail of the primeval salt water dragoness Tiamat, set in the sky by Marduk, the Babylonian national god, after slaying her', 100000, true, 'Milky way', 299792458);
INSERT INTO public.galaxy VALUES (2, 'The Sombrero Galaxy, officially Messier 104 (M104), is a spiral galaxy known for its distinct shape resembling a Mexican sombrero.', 94500, false, 'Sombrero Galaxy', 299792458);
INSERT INTO public.galaxy VALUES (3, 'M63 was first discovered by the French astronomer Pierre Méchain, then later verified by his colleague Charles Messier on 14 June 1779.', 13000, false, 'Sunflower Galaxy', 299792458);
INSERT INTO public.galaxy VALUES (4, 'Because this nearby galaxy is seen edge-on from Earth, professional astronomers observe this galaxy to better understand the gas and stars located outside the plane of the galaxy. .', 30000000, false, 'Whale Galaxy', 299792458);
INSERT INTO public.galaxy VALUES (5, 'With a surface brightness of only 14.42 magnitude, NGC 5829 can be classified as a low-surface brightness galaxy.', 28100000, false, 'Spider Galaxy', 299792458);
INSERT INTO public.galaxy VALUES (6, 'Though the galaxy can be detected with binoculars or a small telescope, to observe the spiral structure in a telescope without a camera requires a fairly large instrument, very dark skies, and a low-power eyepiece', 2100000, false, 'Pinwheel Galaxy', 299792458);
...
INSERT INTO public.planet VALUES (1, 1, 7, 'Mercury', false);
INSERT INTO public.planet VALUES (2, 1, 7, 'Venus', false);
INSERT INTO public.planet VALUES (3, 1, 7, 'Earth', false);
INSERT INTO public.planet VALUES (4, 1, 7, 'Mars', false);
INSERT INTO public.planet VALUES (5, 1, 7, 'Jupiter', false);
INSERT INTO public.planet VALUES (6, 1, 7, 'Saturn', false);
INSERT INTO public.planet VALUES (7, 1, 7, 'Uranus', false);
INSERT INTO public.planet VALUES (8, 1, 7, 'Neptune', false);
INSERT INTO public.planet VALUES (9, 1, 7, 'Pluto', false);
INSERT INTO public.planet VALUES (10, 1, 7, 'Ceres', false);
INSERT INTO public.planet VALUES (11, 1, 7, 'Haumea', false);
INSERT INTO public.planet VALUES (12, 1, 7, 'Makemake', false);
